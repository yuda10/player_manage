        ...
        <div class="info-box-content">
            ...
            <div class="info-box-text d-flex flex-row ml-2">
                ...
                <div class="card mr-2 pb-0">
                    ...
                    @elseif(Auth::user() -> team_id == $team1 -> id || Auth::user()->admin_grade)
        ...
        <div class="info-box-content">
            ...
            <div class="info-box-text d-flex flex-row ml-2">
                ...
                <div class="card mr-2 pb-0">
                    ...
                    @elseif(Auth::user() -> team_id == $team2 -> id || Auth::user()->admin_grade)
        ...
        <div class="info-box-content">
            ...
            <div class="info-box-text d-flex flex-row ml-2">
                ...
                <div class="card mr-2 pb-0">
                    ...
                    @elseif(Auth::user() -> team_id == $team3 -> id || Auth::user()->admin_grade)
        ...
        <div class="info-box-content">
            ...
            <div class="info-box-text d-flex flex-row ml-2">
                ...
                <div class="card mr-2 pb-0">
                    ...
                    @elseif(Auth::user() -> team_id == $team4 -> id || Auth::user()->admin_grade)
